...
import biz.winho.adapter.Friendadapter;
...
public class MainActivity extends Activity {
	...
	public void friendActivity(){
		friendlistview = (ListView)views.get(1). findViewById(R.id.friendlist);
	 ...
	 public void addfriend (View view){
		 Friendentity person = new Friendentity(1, "mabi", "meixinqing", "pengyou");
		 friendDb db = new friendDb(this);
